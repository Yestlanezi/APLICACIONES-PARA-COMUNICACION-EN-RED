...
public class softwareDownload extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setFont(new java.awt.Font("Expo M", 0, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(102, 0, 204));
        jLabel2.setText("Aplicacion de busqueda de archivos");
        ...
        getContentPane().add(btnBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 70, 140, 40));
        ...
        lblResult.setForeground(new java.awt.Color(204, 51, 255));
        lblResult.setText(" Buscar");
        getContentPane().add(lblResult, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 220, 200, 40));
        ...
        getContentPane().add(btnDownload, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 150, 250, 60));

        lblWallpaper.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/degradadomorado.jpg"))); // NOI18N

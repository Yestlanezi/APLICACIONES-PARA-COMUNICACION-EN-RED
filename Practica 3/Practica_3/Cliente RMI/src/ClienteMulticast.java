...
public class ClienteMulticast extends Thread{
    ...
    public ClienteMulticast(database db){
        this.db = db;
        System.out.print( "Cliente Multicast Creado. ");
        try{
    ...
    public void run(){
        ...
        System.out.print( "Cliente Multicast Iniciado.");
        try{
            ...
            while(true){
                ...
                if ( pos == -1){
                    ...
                    System.out.println( "Servidor añadido a la lista: "+recv.getAddress().toString().substring(1));
                }else{

...
public class ClienteUnicast extends Thread{
    ...
    public ClienteUnicast(database db, softwareDownload frameSoftware){
        ...
        this.db = db;
        System.out.print("Cliente Unicast Creado.");
    }
    ...
    public void connectWithServer() {
        ...
        try{
            ...
            System.out.println("Perfectamente Conectado.");
        }catch(Exception e){
    ...
    public void downloadFile(){
        if(cl != null){
        try {
            System.out.println("Solicitando el  siguiente archivo: " + db.getFileFound().getPath().toString());
            ...
            showMessageDialog(null, "Archivo recibido exitosamente.");

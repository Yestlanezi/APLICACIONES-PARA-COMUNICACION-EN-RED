...
public class Manejador extends Thread {
            ...
            if(f.exists()) {
                if (f.delete()) {
                    ...
                    String deleteOK = headers +
                                      "<html><head><meta charset='UTF-8'><title>202 Eliminado</title></head>" +
                                      "<body><h1>202 Se ha elimna correctamente.</h1>" +
                                      "<p>El contenido " + arg + " ha sido eliminado permanentemente del servidor." + 
                                      "Ya no se podra acceder a este contenido.</p>" +
                                      "</body></html>";
    ...
    public String obtenerParametros(String line, String headers, int bandera) {
        ...
        String html = headers +
                      "<html><head><meta charset='UTF-8'><title>Metodo " + metodo + "\n"+"</title><style>body {background-color: #AACCFF;color: #800080;font-family: Arial, sans-serif;}"+
                      "h2 {color: #FF69B4;text-align: center;}"+
                      "table {width: 100%;border-collapse: collapse;margin-top: 20px;}"+
                      "th {background-color: #FF69B4;color: #FFF0F5;padding: 10px;text-align: left;}"+
                      "td {background-color: #FFF0F5;padding: 10px;}"+
                      "tr:nth-child(even) {background-color: #F8F0FF;}</style></head>"+
                    "<body><h2>Parametros obtenidos por medio de " + metodo + "</h2><table border='2'><tr><th>Parametro</th><th>Valor</th></tr>";
                      /*"<html><head><meta charset='UTF-8'><title>Metodo " + metodo + "\n" +
            ...
            if(line == null) {
                ...
                if(line.toUpperCase().startsWith("GET")) {
                    ...
                    String error501 = "HTTP/1.1 501 Not Implemented\n" +
                                      ...
                                      "<p>El método HTTP solicitado no está implementado en el servidor.</p>" +
                                      "</body></html>";
